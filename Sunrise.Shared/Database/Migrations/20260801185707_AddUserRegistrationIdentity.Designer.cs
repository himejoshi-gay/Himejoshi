...
namespace Sunrise.Shared.Database.Migrations
{
    ...
    [Migration("20260801185707_AddUserRegistrationIdentity")]
    partial class AddUserRegistrationIdentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sunrise.Shared.Database.Models.Users.UserRegistrationIdentity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("DiscordAccountCreatedAt")
                        .HasColumnType("datetime(6)");

                    b.Property<string>("DiscordSubjectHash")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("char(64)")
                        .IsFixedLength();
                    ...
                    b.HasIndex("BrowserFingerprintHash");

                    b.HasIndex("DiscordSubjectHash")
                        .IsUnique();
                    ...
                    b.ToTable("user_registration_identity");
                });
            ...
            modelBuilder.Entity("Sunrise.Shared.Database.Models.Users.UserRegistrationIdentity", b =>
                {
                    b.HasOne("Sunrise.Shared.Database.Models.Users.User", "User")
                        .WithOne()
                        .HasForeignKey("Sunrise.Shared.Database.Models.Users.UserRegistrationIdentity", "UserId")
